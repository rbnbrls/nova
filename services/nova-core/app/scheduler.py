...
async def send_morning_briefing_for_user(user_name: str):
    ...
    try:
        ...
        log.warning("send_morning_briefing_for_user(%s) failed: %s", user_name, e)
...
async def send_weekly_briefing_for_user(user_name: str):
    ...
    try:
        ...
        log.warning("send_weekly_briefing_for_user(%s) failed: %s", user_name, e)
...
async def check_at_risk_tasks():
    ...
    try:
        ...
        log.warning("check_at_risk_tasks failed: %s", e)
...
async def check_new_emails():
    ...
    try:
        ...
        log.warning("check_new_emails failed: %s", e)
