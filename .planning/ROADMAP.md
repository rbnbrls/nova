...
- [ ] 15-01-PLAN.md — Audit scheduler wiring, deprecate legacy send_morning_briefing, verify per-user toggle API
...
- [ ] 16-01-PLAN.md — Centralize DND enforcement in dispatcher with correct-channel queuing
...
- [x] 32-01-PLAN.md — Grocery list tools + message relay tool
- [x] 32-02-PLAN.md — Recurring chores with rotation and fair-share nudges
...
- [ ] 33-01-PLAN.md — Calendar-aware gate, deadline escalation, dashboard overdue flag
...
- [ ] 34-01-PLAN.md — Email action extraction, calendar conflict detection, reply drafting
...
| 32. Household Coordination | 2/2 | Complete    | 2026-07-12 |
| 33. Proactivity That Respects Attention | 0/1 | Planning ready | — |
| 34. Deeper Email & Calendar Intelligence | 0/1 | Planning ready | — |
